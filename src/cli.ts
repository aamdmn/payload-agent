...
import {
  copyLocaleCommand,
  copyLocaleGlobalCommand,
} from "./commands/copy-locale.js";
...
async function main(): Promise<void> {
  ...
  // Handle help and version before initializing Payload
