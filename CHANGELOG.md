...
- Upgraded development dependencies to Payload 3.89, Next.js 16.3.5, React 19.3, and updated build and test tooling. Build approvals now use `pnpm-workspace.yaml`, supporting pnpm `>=10.26.0` without an upper bound
